...
//        int j = i - 1;
//        while (j >= 0 && arr[j] > key) {
//            arr[static_cast<vector<int, allocator<int>>::size_type>(j) + 1] = arr[j];
//            j = j - 1;
//        }
//        arr[static_cast<vector<int, allocator<int>>::size_type>(j) + 1] = key;
//    }
//}
//
...
//                asciiCode += 6;
//            }
//            if ((asciiCode >= 65 && asciiCode <= 122) || (asciiCode >= 192 && asciiCode <= 255) || asciiCode == 168 || asciiCode == 184) {
